"""
Kmes has written three integers a, b and c in order to remember that he has to give Noobish_Monk axbxb
bananas.
...
For example, if a=2, b=3 and c=4, then one can increase a three times by one and increase b
two times. After that a=5, b=5, c=4. Then the total number of bananas will be 5x5x5=100
