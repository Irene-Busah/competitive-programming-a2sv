"""
In Berland it is the holiday of equality. In honor of the holiday the king decided to equalize the welfare of all citizens in 
Berland by the expense of the state treasury.
...
maxAmount = max(welfare)

minAmountNeeded = 0

for i in range(len(welfare)):
    remainderAmount = abs(welfare[i] - maxAmount)

    minAmountNeeded += remainderAmount

print(minAmountNeeded)
